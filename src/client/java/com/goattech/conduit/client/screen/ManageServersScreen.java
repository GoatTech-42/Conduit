...
/**
 * Lightweight "Manage Conduit Servers" screen, reachable from the Multiplayer screen whenever
 * there's a still-running tunnel. Lets the user copy the public IP, open the admin panel,
 * or cleanly shut everything down.
 */
public class ManageServersScreen extends Screen {
	...
	public void extractRenderState(GuiGraphicsExtractor g, int mx, int my, float dt) {
		...
		g.centeredText(font,
				Component.translatable("conduit.screen.manage.started", info.startedAt().toString()),
				width / 2, y, 0xAAAAAA);
	}
